...
//
//
package org.ccil.cowan.tagsoup.templates;
...
public class HTMLScanner implements Scanner, Locator {
    ...
    private static int[] statetable = { S_ANAME, '/', A_ANAME_ADUP, S_EMPTYTAG, S_ANAME, '=', A_ANAME, S_AVAL, S_ANAME, '>', A_ANAME_ADUP_STAGC,
            S_PCDATA, S_ANAME, -1, A_ANAME_ADUP_STAGC, S_DONE, S_ANAME, ' ', A_ANAME, S_EQ, S_ANAME, '\n', A_ANAME, S_EQ, S_ANAME, '\t', A_ANAME,
            S_EQ, S_ANAME, 0, A_SAVE, S_ANAME, S_APOS, '\'', A_AVAL, S_TAGWS, S_APOS, -1, A_AVAL_STAGC, S_DONE, S_APOS, ' ', A_SP, S_APOS, S_APOS,
            '\n', A_SP, S_APOS, S_APOS, '\t', A_SP, S_APOS, S_APOS, 0, A_SAVE, S_APOS, S_AVAL, '"', A_SKIP, S_QUOT, S_AVAL, '\'', A_SKIP, S_APOS,
            S_AVAL, '>', A_AVAL_STAGC, S_PCDATA, S_AVAL, -1, A_AVAL_STAGC, S_DONE, S_AVAL, ' ', A_SKIP, S_AVAL, S_AVAL, '\n', A_SKIP, S_AVAL, S_AVAL,
            '\t', A_SKIP, S_AVAL, S_AVAL, 0, A_SAVE, S_STAGC, S_BB, 'C', A_SKIP, S_BBC, S_BB, -1, A_SKIP, S_DONE, S_BB, 0, A_SKIP, S_DECL, S_BBC, 'D',
            A_SKIP, S_BBCD, S_BBC, -1, A_SKIP, S_DONE, S_BBC, 0, A_SKIP, S_DECL, S_BBCD, 'A', A_SKIP, S_BBCDA, S_BBCD, -1, A_SKIP, S_DONE, S_BBCD, 0,
            A_SKIP, S_DECL, S_BBCDA, 'T', A_SKIP, S_BBCDAT, S_BBCDA, -1, A_SKIP, S_DONE, S_BBCDA, 0, A_SKIP, S_DECL, S_BBCDAT, 'A', A_SKIP, S_BBCDATA,
            S_BBCDAT, -1, A_SKIP, S_DONE, S_BBCDAT, 0, A_SKIP, S_DECL, S_BBCDATA, '[', A_SKIP, S_CDSECT, S_BBCDATA, -1, A_SKIP, S_DONE, S_BBCDATA, 0,
            A_SKIP, S_DECL, S_CDATA, '<', A_SAVE, S_CDATA2, S_CDATA, -1, A_PCDATA, S_DONE, S_CDATA, 0, A_SAVE, S_CDATA, S_CDATA2, '/',
            A_UNSAVE_PCDATA, S_ETAG, S_CDATA2, -1, A_UNSAVE_PCDATA, S_DONE, S_CDATA2, 0, A_SAVE, S_CDATA, S_CDSECT, ']', A_SAVE, S_CDSECT1, S_CDSECT,
            -1, A_SKIP, S_DONE, S_CDSECT, 0, A_SAVE, S_CDSECT, S_CDSECT1, ']', A_SAVE, S_CDSECT2, S_CDSECT1, -1, A_SKIP, S_DONE, S_CDSECT1, 0, A_SAVE,
            S_CDSECT, S_CDSECT2, '>', A_CDATA, S_PCDATA, S_CDSECT2, ']', A_SAVE, S_CDSECT2, S_CDSECT2, -1, A_SKIP, S_DONE, S_CDSECT2, 0, A_SAVE,
            S_CDSECT, S_COM, '-', A_SKIP, S_COM2, S_COM, -1, A_CMNT, S_DONE, S_COM, 0, A_SAVE, S_COM2, S_COM2, '-', A_SKIP, S_COM3, S_COM2, -1,
            A_CMNT, S_DONE, S_COM2, 0, A_SAVE, S_COM2, S_COM3, '-', A_SKIP, S_COM4, S_COM3, -1, A_CMNT, S_DONE, S_COM3, 0, A_MINUS, S_COM2, S_COM4,
            '-', A_MINUS3, S_COM4, S_COM4, '>', A_CMNT, S_PCDATA, S_COM4, -1, A_CMNT, S_DONE, S_COM4, 0, A_MINUS2, S_COM2, S_DECL, '-', A_SKIP, S_COM,
            S_DECL, '>', A_SKIP, S_PCDATA, S_DECL, '[', A_SKIP, S_BB, S_DECL, -1, A_SKIP, S_DONE, S_DECL, 0, A_SAVE, S_DECL2, S_DECL2, '>', A_DECL,
            S_PCDATA, S_DECL2, -1, A_SKIP, S_DONE, S_DECL2, 0, A_SAVE, S_DECL2, S_EMPTYTAG, '>', A_EMPTYTAG, S_PCDATA, S_EMPTYTAG, ' ', A_SKIP,
            S_TAGWS, S_EMPTYTAG, '\n', A_SKIP, S_TAGWS, S_EMPTYTAG, '\t', A_SKIP, S_TAGWS, S_EMPTYTAG, 0, A_SAVE, S_ANAME, S_ENT, -1, A_ENTITY,
            S_DONE, S_ENT, 0, A_ENTITY, S_ENT, S_EQ, '=', A_SKIP, S_AVAL, S_EQ, '>', A_ADUP_STAGC, S_PCDATA, S_EQ, -1, A_ADUP_STAGC, S_DONE, S_EQ,
            ' ', A_SKIP, S_EQ, S_EQ, '\n', A_SKIP, S_EQ, S_EQ, '\t', A_SKIP, S_EQ, S_EQ, 0, A_ADUP_SAVE, S_ANAME, S_ETAG, '>', A_ETAG, S_PCDATA,
            S_ETAG, -1, A_ETAG, S_DONE, S_ETAG, ' ', A_SKIP, S_ETAG, S_ETAG, '\n', A_SKIP, S_ETAG, S_ETAG, '\t', A_SKIP, S_ETAG, S_ETAG, 0, A_SAVE,
            S_ETAG, S_GI, '/', A_SKIP, S_EMPTYTAG, S_GI, '>', A_GI_STAGC, S_PCDATA, S_GI, -1, A_SKIP, S_DONE, S_GI, ' ', A_GI, S_TAGWS, S_GI, '\n',
            A_GI, S_TAGWS, S_GI, '\t', A_GI, S_TAGWS, S_GI, 0, A_SAVE, S_GI, S_NCR, -1, A_ENTITY, S_DONE, S_NCR, 0, A_ENTITY, S_NCR, S_PCDATA, '&',
            A_ENTITY_START, S_ENT, S_PCDATA, '<', A_PCDATA, S_TAG, S_PCDATA, -1, A_PCDATA, S_DONE, S_PCDATA, 0, A_SAVE, S_PCDATA, S_PI, '>', A_PI,
            S_PCDATA, S_PI, -1, A_PI, S_DONE, S_PI, 0, A_SAVE, S_PI, S_PITARGET, '>', A_PITARGET_PI, S_PCDATA, S_PITARGET, -1, A_PITARGET_PI, S_DONE,
            S_PITARGET, ' ', A_PITARGET, S_PI, S_PITARGET, '\n', A_PITARGET, S_PI, S_PITARGET, '\t', A_PITARGET, S_PI, S_PITARGET, 0, A_SAVE,
            S_PITARGET, S_QUOT, '"', A_AVAL, S_TAGWS, S_QUOT, -1, A_AVAL_STAGC, S_DONE, S_QUOT, ' ', A_SP, S_QUOT, S_QUOT, '\n', A_SP, S_QUOT, S_QUOT,
            '\t', A_SP, S_QUOT, S_QUOT, 0, A_SAVE, S_QUOT, S_STAGC, '>', A_AVAL_STAGC, S_PCDATA, S_STAGC, -1, A_AVAL_STAGC, S_DONE, S_STAGC, ' ',
            A_AVAL, S_TAGWS, S_STAGC, '\n', A_AVAL, S_TAGWS, S_STAGC, '\t', A_AVAL, S_TAGWS, S_STAGC, 0, A_SAVE, S_STAGC, S_TAG, '!', A_SKIP, S_DECL,
            S_TAG, '/', A_SKIP, S_ETAG, S_TAG, '<', A_SAVE, S_TAG, S_TAG, '?', A_SKIP, S_PITARGET, S_TAG, -1, A_LT_PCDATA, S_DONE, S_TAG, ' ', A_LT,
            S_PCDATA, S_TAG, '\n', A_LT, S_PCDATA, S_TAG, '\t', A_LT, S_PCDATA, S_TAG, 0, A_SAVE, S_GI, S_TAGWS, '/', A_SKIP, S_EMPTYTAG, S_TAGWS,
            '>', A_STAGC, S_PCDATA, S_TAGWS, -1, A_STAGC, S_DONE, S_TAGWS, ' ', A_SKIP, S_TAGWS, S_TAGWS, '\n', A_SKIP, S_TAGWS, S_TAGWS, '\t',
            A_SKIP, S_TAGWS, S_TAGWS, 0, A_SAVE, S_ANAME, S_XNCR, -1, A_ENTITY, S_DONE, S_XNCR, 0, A_ENTITY, S_XNCR,
